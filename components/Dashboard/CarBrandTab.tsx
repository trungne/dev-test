...
const CarBrandInfo: React.FC<{ brand: CarBrand, viewCarBrand: () => void }> = ({ brand, viewCarBrand }) => {
    ...
    return (
        <div className="flex  gap-2 md:gap-0 px-6 py-[30px] items-center flex-wrap">
            <div className="flex w-full gap-2 md:gap-0 md:w-auto justify-center md:justify-start items-center md:min-w-[600px] max-w-[600px]">
                <MantineRadio className="hidden md:block" value={brand.name} />

                <div className=" self-start md:mx-10 relative w-[40px] h-[40px] md:w-[64px] md:h-[64px]">
                    <Image alt="logo" layout="fill" src={brand.logoURL} />
                </div>


                <Divider className="hidden md:block" orientation="vertical" size="sm" color={brand.isActive ? "green" : "gray"} />
                ...
                <div className="md:ml-10">
                    ...
                    <div className="md:flex gap-4 mt-1 items-center">
                        {(viewCarBrandOption === 'all' || viewCarBrandOption === 'brand-name') &&
                            <span className="flex md:block max-w-[200px] text-neutral-6 font-normal text-ellipsis overflow-hidden whitespace-nowrap ">
                                {brand.description}
                            </span>
                        }
            ...
            <div className="grid place-content-center md:flex items-center grow">
                ...
                <div className="flex gap-2 py-2 px-5 md:ml-16 bg-neutral-2">
            ...
            <div id="car-brand-list-header" className="flex items-center flex-wrap">
                ...
                <TextInput
                    ...
                    icon={<SearchIcon fill="#5F5F5F" />} classNames={{
                        root: "mx-auto md:ml-[56px] md:mr-0 basis-[240px]",
                ...
                <UnstyledButton
                    ...
                    mx-auto my-4
                    md:mr-0 md:my-0 md:ml-auto 
                    items-center py-[10px] px-4 flex gap-4 rounded-md basis-[140px]">
